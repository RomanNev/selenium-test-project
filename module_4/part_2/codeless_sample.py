...
class TestUntitled():
    ...
    def test_untitled(self):
        ...
        self.driver.set_window_size(1552, 1050)
        self.driver.find_element(By.ID, "login_link").click()
        self.driver.find_element(By.ID, "id_registration-email").click()
        self.driver.find_element(By.ID, "id_registration-email").send_keys("sdfsdflj234@dsfsdf.ru")
        self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(5)").click()
        self.driver.find_element(By.ID, "id_registration-password1").click()
        self.driver.find_element(By.ID, "id_registration-password1").send_keys("215345234654624325")
        self.driver.find_element(By.ID, "id_registration-password2").click()
        self.driver.find_element(By.ID, "id_registration-password2").send_keys("215345234654624325")
